...
- [Ecommerce Data Pipeline](#ecommerce-data-pipeline)
  ...
  - [Business Insights](#business-insights)
    ...
    - [Customer Segments' Preferences](#customer-segments-preferences)
...
### Start services
> Pre requisites:
> - Before firing up the containers, make sure you create a .env file at the root level. This is for passing your desired environment variables into the containers (particularly your credentials). Please refer to the [.env.example](.env.example) to have a grasp of what you should include.
...
<!-- omit in toc -->
#### "VIP Shoppers" and "Past High Rollers"
